 ...
 * execution (e.g: {@link cucumber.runtime.formatter.JSONFormatter}).
 * <p>
 ...
 * </ul>
 * <p>
 * Plugins are added to the runtime from the command line or @{@link CucumberOptions} and may be provided with an
 * parameter. To accept this parameter the plugin must have a public constructor that accepts one of the following arguments:
 * <ul>
 * <li>{@link String}</li>
